...
This project explores how to turn pictures of one animal into another (like a cat into a dog) using AI. We compared three different methods: VAEs, CycleGAN, and Diffusion Models to see which one works best.
